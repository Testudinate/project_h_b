      ...
      makeHttpRequest("YesorNo-followup", userSpeech, (e) =>{ 
        ...
        if (!res.result){ 
          ...
          player.addEventListener(PlayerEvents.PlaybackFinished, () => {
            ...
            Net.httpRequest("https://sms.ru/sms/send?api_id=51D201BA-943E-7B0B-C0E0-7FA116B0BCA9&to="+ phone_number +"&msg=https://hr-bot.typeform.com/to/fmLaWN&json=1", function(e) {
						  if(e.code == 200) { 
